package org.kotlinmc.bukkit.skedule
...
fun Plugin.schedule(initialContext: SynchronizationContext = SynchronizationContext.SYNC,
 ...
 */
fun BukkitScheduler.schedule(plugin: Plugin, initialContext: SynchronizationContext = SynchronizationContext.SYNC,
                             co: suspend BukkitSchedulerController.() -> Unit): CoroutineTask {
